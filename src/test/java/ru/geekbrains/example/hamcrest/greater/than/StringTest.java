...
public class StringTest {
    ...
    void containsStringTest() {
        String name1 = "Лорд Лорд Лорд GeekBrains Лорд";
    ...
    void endsWithTest() {
        String name1 = "Лорд Лорд Лорд GeekBrains Лорд";
        MatcherAssert.assertThat(name1 ,endsWith("Лорд"));
    ...
    void equalToCompressingWhiteSpaceTest() {
        String name1 = "     Лорд          Лорд Лорд          GeekBrains Лорд   ";
        MatcherAssert.assertThat(name1 ,equalToCompressingWhiteSpace("Лорд Лорд Лорд GeekBrains Лорд"));
